...
const Discord = require("discord.js");
    ...
    m.react("854831306373332993");
    setTimeout(() => {
      if (m.reactions.cache.get("854831306373332993").count <= 1) {
        return message.channel.send(
