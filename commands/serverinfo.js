...
exports.run = async (client, message, args) => {
    ...
    .addField(`:pencil:  ID do Propietário do Servidor`, message.guild.ownerID, true)
    .addField(':date: Server Criado em', message.guild.createdAt, true)
    .addField(`:closed_lock_with_key: Level de verificação do server`, message.guild.verificationLevel, true)
