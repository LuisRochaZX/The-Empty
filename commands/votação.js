...
if (!args[0]) {
  ...
  return message.channel.send(`${message.author.username}, forneça um assunto com no máximo 1000 caracteres.`);
} else {
  var canal = message.guild.channels.cache.find(ch => ch.id === "767011468028805140");
